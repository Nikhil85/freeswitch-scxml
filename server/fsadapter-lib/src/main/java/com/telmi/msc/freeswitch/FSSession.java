...
public interface FSSession {
     ...
     *         the say action.
     */
    FSEvent say(String moduleName, String sayType, String sayMethod, String value);
     ...
     */
    FSEvent recordFile(int timeLimitInMs, boolean beep, Set<DTMFMessage> terms,
            String format);
     ...
     */
    FSEvent getDigits(int maxdigits, Set<DTMFMessage> terms, long timeout);
     ...
     */
    FSEvent read(int maxDigits, String prompt, long timeout, Set<DTMFMessage> terms);
     ...
     */
    FSEvent streamFile(String file);
     ...
     *         the stream file action.
     */
    FSEvent streamFile(String value, Set<DTMFMessage> terms);
     ...
     *
     */
    FSEvent hangup(Map<String, Object> nameList);
