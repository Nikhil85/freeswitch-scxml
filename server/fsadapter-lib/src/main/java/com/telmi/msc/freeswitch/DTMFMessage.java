...
public enum DTMFMessage {
     ...
     */
    private static final Map<Character, DTMFMessage> CACHE =
            new HashMap<Character, DTMFMessage>();

    static {

        EnumSet<DTMFMessage> dtmfs = EnumSet.allOf(DTMFMessage.class);

        for (DTMFMessage d : dtmfs) {
     ...
     *
     **/
    private DTMFMessage(final char charV) {
     ...
     *
     */
    public static Set<DTMFMessage> createCollectionFromString(String toDtmf) {
        ...
        Set<DTMFMessage> dtmfs = EnumSet.noneOf(DTMFMessage.class);
...
//    }
     ...
     */
    public static final DTMFMessage valueOfChar(final char charValue) {
     ...
     */
    private static void fillCollection(String toDtmf, Collection<DTMFMessage> dtmfs) {
