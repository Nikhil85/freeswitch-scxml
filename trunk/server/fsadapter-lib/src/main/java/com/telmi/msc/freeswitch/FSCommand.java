...
//     */
//    static final String GENTONES =
//            BASE_COMMAND +  "gentones\n"
//            + "execute-app-arg: %(%s,%s,%s)\n\n";
//    /**
//     * BEEP
//     * generated by gentones
//     */
//    static final String BEEP =
//            BASE_COMMAND + "gentones\n"
//            + "execute-app-arg: %(500,0,800)\n\n";
//    static final String REFER = BASE_COMMAND + "deflect\nexecute-app-arg: %s\n\n";
